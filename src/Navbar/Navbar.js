...
const Navbar = () => {
  ...
  const handelMenuBar = () => {
    ...
    console.log("menubar", showMenu);
  };

  const handelClose = () => {
    setShowMenu(false);
    console.log("CloseIcon", showMenu);
  };
      ...
      <div className="container" style={{ display: "flex", justifyContent: "space-between" }}>
        <div>
          <div className="logo-container">
            <h5>
              <a href="/" id="logo" alt="SpaceX - go to homepage">
                <svg version="1.1" x="0px" y="0px" viewBox="0 0 400 50">
                  ...
                  <g class="letter_s" style={{ color: "#fff" }}>
                    <path
                      class="fill-white"
            ...
            {/* <img className='img-logo' src={Logo} alt="SpaceX.logo" width={100}/> */}
          </div>
        </div>
        <div>
          <div className="Navbar">
            <ul style={{ marginBottom: 0 }}>
              ...
              <li>
                <a href="//#" exact to="/courts" className="navName">
                  Dragon
                </a>
              </li>
              <li>
        ...
        <div>
          <div className="nav-btn-container">
            ...
            <div className="nav-bar-btn">
              <ul>
                <li>
                  <FaBars size={20} color="#fff" onClick={handelMenuBar} />
                </li>
              </ul>
            </div>
          </div>
